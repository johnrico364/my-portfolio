  ...
  return (
    <div className={style.main_container}>
      <div className="basis-full lg:basis-1/2 flex justify-center">
        <img
          src="/assets/aboutme/me_img.png"
          className="h-[12rem] lg:h-[30rem] mt-[2rem] lg:mt-[8rem]"
        />
      </div>
      <div className="basis-full lg:basis-1/2 flex flex-col items-center">
        <img
          src="/assets/aboutme/aboutme_text.png"
          className="h-[2.5rem] mt-[2rem] lg:mt-[8rem]"
        />
        <div className="mt-4 px-8 text-[0.8rem] lg:text-[1rem] text-justify">
